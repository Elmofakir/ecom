...
<span style="font-size:30px;cursor:pointer; color: white;" class="nav2"  >&#9776; Statistiques</span>
	...
	<div class="col-div-3">
		<div class="box">
			<p>8<br/><span>Cours</span></p>
			<i class="fa fa-television box-icon"></i>
		</div>
	</div>
	<div class="col-div-3">
		<div class="box">
			<p>88<br/><span>Destinataire</span></p>
			<i class="fa fa-users box-icon"></i>
		</div>
	</div>
	<div class="col-div-3">
		<div class="box">
			<p>99<br/><span>Leçon</span></p>
			<i class="fa fa-cubes box-icon"></i>
		</div>
	</div>
	<div class="col-div-3">
		<div class="box">
			<p>60<br/><span>Bénéfices</span></p>
...
<table>
  ...
  <tr>
	...
	<div class="col-div-4">
		<div class="box-4">
		<div class="content-box">
			<p>Le plus regardé <span>Laravel</span></p><
